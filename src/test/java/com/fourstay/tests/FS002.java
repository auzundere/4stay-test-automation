...
public class FS002 extends TestBaseClass {
	/**
	 * NOTE: This website accepts only 1 time registration and when you have
	 * registered the account, and try to use same credentials, it is just logging
	 * in. It is NOT using the registration page any more. Which is if you really
	 * create a new account, it tests that part, and if you have already once, it
	 * will skip those steps in my current try catch block, For this reason, after
	 * try catch block, code is finished.
	 * 
	 */
