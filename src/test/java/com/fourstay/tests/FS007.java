...
public class FS007 extends TestBaseClass {
	...
	public void Test7() throws InterruptedException {
		...
		driver.findElement(By.xpath("(//div[@class='calendar-table']//tbody/tr[" + idx1 + "]/td[" + idx2 + "])[1]"))
				.click();
		...
		driver.findElement(By.xpath("(//div[@class='calendar-table']//tbody/tr[" + idx1 + "]/td[" + idx2 + "])[3]"))
				.click();
		// click NEXT
		dashboardPage.nextButton.click();
		...
		count = 1;
		while (count < 8) {
			dashboardPage.uploadPhotos
					.sendKeys(System.getProperty("user.dir") + "/src/test/resources/img/hp" + count + ".jpg");
			count++;
		}
		Thread.sleep(4000);
	...
	public static void clickElements(int totalSize, int numberofElementSelect, List<WebElement> element,
			int startIndex) {
		Random rand = new Random();
