...
public class FS003 extends TestBaseClass {
	...
	public void Test3() throws InterruptedException {
		...
		// * verify that text "Log in to use your Facebook account with 4stay" is
		// displayed
		softAssert.assertTrue(facebookPage.textInfo.getText().contains("Log in to use your Facebook account"));

		// 1) Enter valid Facebook account information
		...
		List<WebElement> labelOccupation = driver
				.findElements(By.xpath("//label[contains(text(),'Occupation/School')]"));
		...
		// 1) Fill up the input fields except for "Tell us about yourself" and
		// "Year of birth"
